...
const links = {
  Services: ["Infrastructure Dev", "Web Design", "AI Implementation", "Process Automation", "Custom Applications"],
  Company: ["About", "Careers", "Contact", "Partners"],
  Resources: ["Case Studies", "Blog", "Documentation", "Events"],
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-14">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4 text-slate-400">
              {/* X / Twitter */}
              <a href="#" className="hover:text-[#FF4F27] transition-colors">
            ...
            {Object.entries(links).map(([category, items]) => (
              <div key={category}>
                ...
                <ul className="space-y-3">
                  {items.map((item) => (
                    <li key={item}>
                      <a href="#" className="text-[13px] text-slate-400 hover:text-white transition-colors">
                        {item}
                      </a>
                    </li>
                  ))}
