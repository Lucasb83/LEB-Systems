...
const MiniLogo: React.FC = () => {
  ...
  return (
    <div className="w-10 h-10 border border-white/10 rounded-full bg-[#243347] flex items-center justify-center shadow-[0_0_15px_rgba(6,182,212,0.3)] relative overflow-hidden">
...
export default function Footer() {
  ...
  return (
    <section ref={containerRef} className="relative pt-40 pb-12 px-6 z-10 overflow-hidden mt-10">
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#06B6D4]/55 via-[#0891B2]/10 to-transparent blur-[100px] rounded-[100%]" />
      </motion.div>
      ...
      {/* Footer card */}
      <div className="max-w-[1200px] mx-auto bg-[#243347] border border-white/5 rounded-[2rem] p-10 md:p-16 relative overflow-hidden z-20 shadow-2xl backdrop-blur-sm">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent via-[#06B6D4]/40 to-transparent" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-14">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4 text-slate-400">
              ...
              {/* GitHub */}
              <a href="https://github.com/lebsystems" target="_blank" rel="noopener noreferrer" aria-label="LEB Systems on GitHub" className="hover:text-[#06B6D4] transition-colors p-1">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/company/lebsystems" target="_blank" rel="noopener noreferrer" aria-label="LEB Systems on LinkedIn" className="hover:text-[#06B6D4] transition-colors p-1">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
