...
const pillars = [
  {
    icon: <MapPin className="w-4 h-4 text-[#06B6D4]" />,
  ...
  {
    icon: <Key className="w-4 h-4 text-[#06B6D4]" />,
        ...
        <div className="flex-1 w-full">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 group bg-[#1E293B] p-8 flex flex-col gap-6">
            ...
            <div className="relative z-10 flex items-center gap-4 p-5 bg-[#243347] border border-white/5 rounded-2xl">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#06B6D4] to-[#10B981] flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
                L
              </div>
              <div>
                <p className="text-white font-semibold">Lucas</p>
                <p className="text-xs text-slate-400">Auckland, New Zealand</p>
                <p className="text-xs text-[#06B6D4] mt-1">Available for new projects</p>
              </div>
            </div>

            {/* Trust stats */}
            <div className="relative z-10 grid grid-cols-3 gap-4">
              <div className="flex flex-col items-center bg-[#0F172A]/80 border border-white/5 rounded-2xl p-4">
                <span className="text-2xl font-bold text-white">50+</span>
                <span className="text-xs text-slate-400 text-center mt-1">Projects delivered</span>
              </div>
              <div className="flex flex-col items-center bg-[#0F172A]/80 border border-white/5 rounded-2xl p-4">
                <span className="text-2xl font-bold text-[#06B6D4]">NZ</span>
