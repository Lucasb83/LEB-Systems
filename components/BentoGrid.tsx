      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        >
          ...
          <div className="flex-1 z-10 flex flex-col justify-center">
            ...
            <a href="/services#booking" className="inline-flex items-center gap-2 text-sm text-white font-medium px-5 py-2.5 bg-[#1E293B] border border-white/10 group-hover:border-[#06B6D4]/40 rounded-lg transition-colors w-fit">
            ...
            <div className="w-full max-w-xs bg-[#0F172A] border border-white/5 rounded-2xl p-5 shadow-2xl group-hover:border-white/15 transition-colors">
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  <div key={b.time} className="flex items-center justify-between bg-[#243347] p-2.5 rounded-lg border border-white/5">
        ...
        <motion.div
          variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
          className="md:col-span-12 bg-[#1E293B] border border-white/5 rounded-3xl p-10 flex flex-col md:flex-row items-center gap-12 group hover:border-white/10 hover:shadow-[0_0_50px_rgba(147,51,234,0.12)] transition-all duration-500 cursor-default overflow-hidden relative"
        >
          ...
          <div className="flex-1 w-full flex justify-center z-10">
            <div className="bg-[#0F172A] border border-white/10 rounded-2xl p-6 relative w-full max-w-xs group-hover:border-white/20 transition-colors">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#1E293B] px-3 py-1 text-[10px] text-slate-400 font-bold uppercase tracking-widest border border-white/5 rounded-full">
                WhatsApp Bot
              </div>
                ...
                {[
                  ...
                  <div
                    ...
                    className={`text-xs px-3 py-2 rounded-xl max-w-[80%] ${
                      m.from === "customer"
                        ? "bg-[#243347] text-slate-300 border border-white/5"
